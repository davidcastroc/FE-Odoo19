...
class FacturaElectronica(GeneratedsSuper):
    ...
    def __init__(self, Clave, CodigoActividad, NumeroConsecutivo, FechaEmision, Emisor,
                 Receptor, CondicionVenta, MedioPago, PlazoCredito=0, DetalleServicio=None,
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Clave':
            ...
            self.MedioPago.append(MedioPago_)
...
class EmisorType(GeneratedsSuper):
    ...
    def __init__(self, Nombre, Identificacion, Ubicacion, CorreoElectronico, NombreComercial=None, Telefono=None,
                 Fax=None):
        self.original_tagname_ = None
        self.Nombre = Nombre
...
class ImpuestoType(GeneratedsSuper):
    ...
    def __init__(self, Codigo=None, CodigoTarifa=None, Tarifa=None, FactorIVA=None, Monto=None, Exoneracion=None):
        self.original_tagname_ = None
        self.Codigo = Codigo
...
# end class CodigoTipoMonedaType
...
class LineaDetalleType(GeneratedsSuper):
    ...
    def __init__(self, NumeroLinea, Codigo, Cantidad, CodigoComercial=None, UnidadMedida=None,
                 UnidadMedidaComercial=None, Detalle=None, RegistroMedicamento=None, FormaFarmaceutica=None,
                 PrecioUnitario=None, MontoTotal=0.00, Descuento=None, SubTotal=None, BaseImponible=None,
