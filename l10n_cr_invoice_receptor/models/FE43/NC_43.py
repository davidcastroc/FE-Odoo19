...
class NotaCreditoElectronica(GeneratedsSuper):
    ...
    def __init__(self, Clave, CodigoActividad, NumeroConsecutivo, FechaEmision, Emisor,
                 CondicionVenta, Receptor=None, PlazoCredito=0, MedioPago=None, DetalleServicio=None,
                 OtrosCargos=None, ResumenFactura=None, InformacionReferencia=None, Normativa=None, Otros=None):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='NotaCreditoElectronica', fromsubclass_=False,
        ...
        if self.CodigoActividad is not None:
            ...
            outfile.write(bytes(('<CodigoActividad>%s</CodigoActividad>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.CodigoActividad), input_name='CodigoActividad')),
                eol_)).encode()))
        ...
        for MedioPago_ in self.MedioPago:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<MedioPago>%s</MedioPago>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(MedioPago_), input_name='MedioPago')),
                eol_)).encode()))
...
# end class NotaCreditoElectronica
...
class ReceptorType(GeneratedsSuper):
    ...
    def __init__(self, Nombre=None, Identificacion=None, IdentificacionExtranjero=None, NombreComercial=None,
                 Ubicacion=None, OtrasSenasExtranjero=None, Telefono=None, Fax=None, CorreoElectronico=None):
        self.original_tagname_ = None
        self.Nombre = Nombre
        self.Identificacion = Identificacion
...
class ImpuestoType(GeneratedsSuper):
    ...
    def __init__(self, Codigo=None, CodigoTarifa=None, Tarifa=None, FactorIVA=None, Monto=None, MontoExportacion=None,
                 Exoneracion=None):
        self.original_tagname_ = None
        self.Codigo = Codigo
        self.CodigoTarifa = CodigoTarifa
        self.Tarifa = Tarifa
    ...
    def get_CodigoTarifa(self):
        return self.CodigoTarifa

    def set_CodigoTarifa(self, CodigoTarifa):
        self.CodigoTarifa = CodigoTarifa
    ...
    def hasContent_(self):
        if (
                ...
                self.CodigoTarifa is not None or
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ImpuestoType', fromsubclass_=False,
        ...
        if self.CodigoTarifa is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<CodigoTarifa>%s</CodigoTarifa>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.CodigoTarifa), input_name='CodigoTarifa')),
                eol_)).encode()))
...
class OtrosCargosType(GeneratedsSuper):
    ...
    def __init__(self, TipoDocumento, MontoCargo=None, NumeroIdentidadTercero=None, NombreTercero=None, Detalle=None,
                 Porcentaje=None):
        self.original_tagname_ = None
        self.TipoDocumento = TipoDocumento
...
class LineaDetalleType(GeneratedsSuper):
    ...
    def __init__(self, NumeroLinea, Codigo, Cantidad, PartidaArancelaria=None, CodigoComercial=None,
                 UnidadMedida=None, UnidadMedidaComercial=None, Detalle=None, RegistroMedicamento=None,
                 FormaFarmaceutica=None, PrecioUnitario=None, MontoTotal=None,
                 Descuento=None, SubTotal=None, BaseImponible=None, Impuesto=None, ImpuestoNeto=None,
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='LineaDetalleType', fromsubclass_=False,
        ...
        if self.RegistroMedicamento is not None:
            ...
            outfile.write(bytes(('<RegistroMedicamento>%s</RegistroMedicamento>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.RegistroMedicamento), input_name='RegistroMedicamento')),
                eol_)).encode()))
        if self.FormaFarmaceutica is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<FormaFarmaceutica>%s</FormaFarmaceutica>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.FormaFarmaceutica), input_name='FormaFarmaceutica')),
                eol_)).encode()))
...
class ResumenFacturaType(GeneratedsSuper):
    ...
    def __init__(self, CodigoTipoMoneda=None, TotalServGravados=None, TotalServExentos=None, TotalServExonerado=None,
                 ...
                 TotalImpuesto=0.00, TotalIVADevuelto=None, TotalOtrosCargos=None, TotalComprobante=None):
        self.original_tagname_ = None
    ...
    def hasContent_(self):
        if (
                ...
                self.TotalComprobante is not None
        ):
            return True
        else:
            return False
...
# end class InformacionReferenciaType
...
def parseString(inString, silence=False):
    ...
    rootObj = rootClass.factory(Clave=None, CodigoActividad=None, NumeroConsecutivo=None, FechaEmision=None,
                                Emisor=None, CondicionVenta=None)
