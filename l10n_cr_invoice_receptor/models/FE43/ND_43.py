...
class NotaDebitoElectronica(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, NotaDebitoElectronica)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if NotaDebitoElectronica.subclass:
            return NotaDebitoElectronica.subclass(*args_, **kwargs_)
        else:
            return NotaDebitoElectronica(*args_, **kwargs_)
    ...
    def export(self, outfile, level, namespace_='', name_='NotaDebitoElectronica', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('NotaDebitoElectronica')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='NotaDebitoElectronica')
        if self.hasContent_():
            outfile.write(bytes(('>%s' % (eol_,)).encode()))
            self.exportChildren(outfile, level + 1, namespace_='', name_='NotaDebitoElectronica',
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='NotaDebitoElectronica'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='NotaDebitoElectronica', fromsubclass_=False,
                       pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
...
# end class NotaDebitoElectronica
...
class LineaDetalleType(GeneratedsSuper):
    ...
    def __init__(self, NumeroLinea=None, PartidaArancelaria=None, Codigo=None, CodigoComercial=None, Cantidad=None,
