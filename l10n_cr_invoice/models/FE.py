...
class FacturaElectronica(GeneratedsSuper):
    ...
    def __init__(self, Clave, ProveedorSistemas, CodigoActividadEmisor, NumeroConsecutivo, FechaEmision, Emisor,
                 Receptor, CondicionVenta, PlazoCredito=0, CodigoActividadReceptor=None,
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, FacturaElectronica)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if FacturaElectronica.subclass:
            return FacturaElectronica.subclass(*args_, **kwargs_)
        else:
            return FacturaElectronica(*args_, **kwargs_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Clave':
            ...
            self.CodigoActividadEmisor = CodigoActividad_
            ...
            PlazoCredito_ = child_.text
            self.PlazoCredito = PlazoCredito_
            ...
            obj_ = OtrosCargosType.factory(TipoDocumentoOC=None, MontoCargo=None)
            obj_.build(child_)
            self.OtrosCargos.append(obj_)
            obj_.original_tagname_ = 'OtrosCargos'
        elif nodeName_ == 'ResumenFactura':
            obj_ = ResumenFacturaType.factory(CodigoTipoMoneda=None)
            obj_.build(child_)
...
class EmisorType(GeneratedsSuper):
    ...
    def __init__(self, Nombre, Identificacion, CorreoElectronico, Ubicacion, NombreComercial=None, Telefono=None):
        self.original_tagname_ = None
        self.Nombre = Nombre
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Nombre':
            ...
            NombreComercial_ = child_.text
            NombreComercial_ = self.gds_validate_string(NombreComercial_, node, 'NombreComercial')
            self.NombreComercial = NombreComercial_
...
class ReceptorType(GeneratedsSuper):
    ...
    def __init__(self, Nombre, Identificacion, IdentificacionExtranjero=None, NombreComercial=None,
...
class UbicacionType(GeneratedsSuper):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Provincia':
            ...
            OtrasSenas_ = child_.text
            OtrasSenas_ = self.gds_validate_string(OtrasSenas_, node, 'OtrasSenas')
            self.OtrasSenas = OtrasSenas_
...
class ExoneracionType(GeneratedsSuper):
    ...
    def __init__(self, TipoDocumento=None, NumeroDocumento=None, NombreInstitucion=None, FechaEmision=None,
                 TarifaExonerada=None, MontoExoneracion=None):
        self.original_tagname_ = None
        ...
        self.TarifaExonerada = TarifaExonerada
    ...
    def get_TarifaExonerada(self):
        return self.TarifaExonerada

    def set_TarifaExonerada(self, TarifaExonerada):
        self.TarifaExonerada = TarifaExonerada
    ...
    def hasContent_(self):
        if (
                ...
                self.FechaEmision is not None or
                self.TarifaExonerada is not None or
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ExoneracionType', fromsubclass_=False,
        ...
        if self.TipoDocumento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<TipoDocumentoEX1>%s</TipoDocumentoEX1>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.TipoDocumento), input_name='TipoDocumentoEX1')),
                eol_)).encode()))
        ...
        if self.FechaEmision is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<FechaEmisionEX>%s</FechaEmisionEX>%s' % (
                self.gds_format_datetime(self.FechaEmision, input_name='FechaEmisionEX'), eol_)).encode()))
        if self.TarifaExonerada is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<TarifaExonerada>%s</TarifaExonerada>%s' % (
                self.gds_format_integer(self.TarifaExonerada, input_name='TarifaExonerada'),
                eol_)).encode()))
...
class OtrosCargosType(GeneratedsSuper):
    ...
    def __init__(self, TipoDocumentoOC, MontoCargo, NumeroIdentidadTercero=None, NombreTercero=None, Detalle=None,
                 PorcentajeOC=None):
        self.original_tagname_ = None
...
class LineaDetalleType(GeneratedsSuper):
    ...
    def __init__(self, NumeroLinea, Cantidad, CodigoCABYS=None, BaseImponible=None, ImpuestoAsumidoEmisorFabrica=None,
                 CodigoComercial=None, UnidadMedida=None, UnidadMedidaComercial=None, Detalle=None,
                 RegistroMedicamento=None, FormaFarmaceutica=None, DetalleSurtido=None, PrecioUnitario=None,
                 MontoTotal=0.00, Descuento=None, SubTotal=None, Impuesto=None, ImpuestoNeto=None, MontoTotalLinea=None):
        self.original_tagname_ = None
...
class ResumenFacturaType(GeneratedsSuper):
    ...
    def __init__(self, CodigoTipoMoneda, TotalServGravados=None, TotalServExentos=None, TotalServExonerado=None,
                 ...
                 TotalDesgloseImpuesto=None, MedioPago=None, TotalServNoSujeto=None, TotalMercNoSujeta=None, TotalNoSujeto=None):
        self.original_tagname_ = None
        ...
        self.TotalServNoSujeto = TotalServNoSujeto
        self.TotalMercNoSujeta = TotalMercNoSujeta
        self.TotalNoSujeto = TotalNoSujeto
    ...
    def hasContent_(self):
        if (
                ...
                self.TotalServNoSujeto is not None or
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ResumenFacturaType', fromsubclass_=False,
        ...
        if self.TotalServNoSujeto is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<TotalServNoSujeto>%s</TotalServNoSujeto>%s' % (
                self.gds_format_float(self.TotalServNoSujeto, input_name='TotalServNoSujeto'), eol_)).encode()))
        ...
        if self.TotalMercNoSujeta is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<TotalMercNoSujeta>%s</TotalMercNoSujeta>%s' % (
                self.gds_format_float(self.TotalMercNoSujeta, input_name='TotalMercNoSujeta'), eol_)).encode()))
        ...
        if self.TotalNoSujeto is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<TotalNoSujeto>%s</TotalNoSujeto>%s' % (
                self.gds_format_float(self.TotalNoSujeto, input_name='TotalNoSujeto'), eol_)).encode()))
...
def parseString(inString, silence=False):
    ...
    rootObj = rootClass.factory(Clave=None, ProveedorSistemas=None, CodigoActividadEmisor=None, NumeroConsecutivo=None,
                                FechaEmision=None, Emisor=None, Receptor=None, CondicionVenta=None)
