...
class NotaCreditoElectronica(GeneratedsSuper):
    ...
    def __init__(self, Clave, ProveedorSistemas, CodigoActividadEmisor, NumeroConsecutivo, FechaEmision, Emisor,
                 CondicionVenta, Receptor=None, PlazoCredito=0, CodigoActividadReceptor=None,
                 DetalleServicio=None, OtrosCargos=None, ResumenFactura=None, InformacionReferencia=None,
                 Normativa=None, Otros=None):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, NotaCreditoElectronica)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if NotaCreditoElectronica.subclass:
            return NotaCreditoElectronica.subclass(*args_, **kwargs_)
        else:
            return NotaCreditoElectronica(*args_, **kwargs_)
    ...
    def set_Normativa(self, Normativa):
        self.Normativa = Normativa
    ...
    def export(self, outfile, level, namespace_='', name_='NotaCreditoElectronica', namespacedef_='',
               pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('NotaCreditoElectronica')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='NotaCreditoElectronica')
        if self.hasContent_():
            outfile.write(bytes(('>%s' % (eol_,)).encode()))
            self.exportChildren(outfile, level + 1, namespace_='', name_='NotaCreditoElectronica',
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='NotaCreditoElectronica'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='NotaCreditoElectronica', fromsubclass_=False,
                       pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
        ...
        for InformacionReferencia_ in self.InformacionReferencia:
            InformacionReferencia_.export(outfile, level, namespace_, name_='InformacionReferencia',
                                          pretty_print=pretty_print)
        if self.Normativa is not None:
            self.Normativa.export(outfile, level, namespace_, name_='Normativa', pretty_print=pretty_print)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Clave':
        ...
        elif nodeName_ == 'CodigoActividadEmisor':
            self.CodigoActividadEmisor = child_.text
            ...
            obj_ = EmisorType.factory(Nombre=None, Identificacion=None, Ubicacion=None, CorreoElectronico=None)
            obj_.build(child_)
            self.Emisor = obj_
...
class EmisorType(GeneratedsSuper):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Nombre':
            ...
            obj_ = UbicacionType.factory(Provincia=None, Canton=None, Distrito=None)
            obj_.build(child_)
            self.Ubicacion = obj_
...
class ReceptorType(GeneratedsSuper):
    ...
    def __init__(self, Nombre=None, Identificacion=None, IdentificacionExtranjero=None, NombreComercial=None,
                 Ubicacion=None, OtrasSenasExtranjero=None, Telefono=None, CorreoElectronico=None):
        self.original_tagname_ = None
        self.Nombre = Nombre
        self.Identificacion = Identificacion
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Nombre':
            ...
            self.OtrasSenasExtranjero = child_.text
        elif nodeName_ == 'Telefono':
            obj_ = TelefonoType.factory()
            obj_.build(child_)
            self.Telefono = obj_
...
class UbicacionType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='UbicacionType', fromsubclass_=False,
        ...
        #         self.gds_format_integer(self.Barrio, input_name='Barrio').zfill(2), eol_)).encode()))
        if self.Barrio is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<Barrio>%s</Barrio>%s' % (
...
class ImpuestoType(GeneratedsSuper):
    ...
    def __init__(self, Codigo=None, CodigoTarifaIVA=None, Tarifa=None, FactorIVA=None, Monto=None,
                 MontoExportacion=None, Exoneracion=None, indicator_prod_service=None):
        self.original_tagname_ = None
        self.Codigo = Codigo
    ...
    def hasContent_(self):
        if (
                ...
                self.MontoExportacion is not None or
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'MontoExportacion':
            self.MontoExportacion = child_.text
...
class DescuentoType(GeneratedsSuper):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'MontoDescuento':
            self.MontoDescuento = float(child_.text)
        elif nodeName_ == 'CodigoDescuento':
            self.CodigoDescuento = child_.text
...
class OtrosCargosType(GeneratedsSuper):
    ...
    def __init__(self, TipoDocumentoOC, MontoCargo=None, NumeroIdentidadTercero=None, NombreTercero=None, Detalle=None,
                 PorcentajeOC=None):
        self.original_tagname_ = None
        self.TipoDocumentoOC = TipoDocumentoOC
        self.NumeroIdentidadTercero = NumeroIdentidadTercero
        self.NombreTercero = NombreTercero
        self.Detalle = Detalle
        self.PorcentajeOC = PorcentajeOC
    ...
    def get_TipoDocumentoOC(self):
        return self.TipoDocumentoOC

    def set_TipoDocumentoOC(self, TipoDocumentoOC):
        self.TipoDocumentoOC = TipoDocumentoOC
    ...
    def get_PorcentajeOC(self):
        return self.PorcentajeOC

    def set_PorcentajeOC(self, PorcentajeOC):
        self.PorcentajeOC = PorcentajeOC
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='OtrosCargosType', fromsubclass_=False,
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.TipoDocumentoOC is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<TipoDocumentoOC>%s</TipoDocumentoOC>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.TipoDocumentoOC), input_name='TipoDocumentoOC')),
                eol_)).encode()))
        ...
        if self.Detalle is not None:
            ...
            outfile.write(bytes(('<Detalle>%s</Detalle>%s' % (
                ...
                eol_)).encode()))
        if self.PorcentajeOC is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<PorcentajeOC>%s</PorcentajeOC>%s' % (
                self.gds_format_float(self.PorcentajeOC, input_name='PorcentajeOC'), eol_)).encode()))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TipoDocumento':
            self.TipoDocumento = child_.text
        elif nodeName_ == 'NumeroIdentidadTercero':
            self.NumeroIdentidadTercero = child_.text
        elif nodeName_ == 'NombreTercero':
            self.NombreTercero = child_.text
...
class LineaDetalleType(GeneratedsSuper):
    ...
    def __init__(self, NumeroLinea, Cantidad, CodigoCABYS=None, BaseImponible=None, ImpuestoAsumidoEmisorFabrica=None,
                 PartidaArancelaria=None, CodigoComercial=None, UnidadMedida=None, UnidadMedidaComercial=None,
                 Detalle=None, RegistroMedicamento=None, FormaFarmaceutica=None, DetalleSurtido=None,
                 PrecioUnitario=None, MontoTotal=None, Descuento=None, SubTotal=None, Impuesto=None, ImpuestoNeto=None,
                 MontoTotalLinea=None):
        self.original_tagname_ = None
        ...
        self.ImpuestoAsumidoEmisorFabrica = ImpuestoAsumidoEmisorFabrica
    ...
    def get_ImpuestoAsumidoEmisorFabrica(self):
        return self.ImpuestoAsumidoEmisorFabrica

    def set_ImpuestoAsumidoEmisorFabrica(self, ImpuestoAsumidoEmisorFabrica):
        self.ImpuestoAsumidoEmisorFabrica = ImpuestoAsumidoEmisorFabrica
    ...
    def hasContent_(self):
        if (
                ...
                self.Impuesto or
                self.ImpuestoAsumidoEmisorFabrica is not None or
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='LineaDetalleType', fromsubclass_=False,
        ...
        if self.CodigoCABYS is not None:
            ...
            outfile.write(bytes(('<CodigoCABYS>%s</CodigoCABYS>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.CodigoCABYS), input_name='CodigoCABYS')),
                eol_)).encode()))
        ...
        if self.ImpuestoAsumidoEmisorFabrica is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<ImpuestoAsumidoEmisorFabrica>%s</ImpuestoAsumidoEmisorFabrica>%s' % (
                self.gds_format_float(self.ImpuestoAsumidoEmisorFabrica, input_name='ImpuestoAsumidoEmisorFabrica'),
                eol_)).encode()))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'NumeroLinea':
        ...
        elif nodeName_ == 'PartidaArancelaria':
            self.PartidaArancelaria = child_.text
            ...
            obj_ = DescuentoType.factory(CodigoDescuento=None)
            obj_.build(child_)
...
class ResumenFacturaType(GeneratedsSuper):
    ...
    def __init__(self, CodigoTipoMoneda=None, TotalServGravados=None, TotalServExentos=None, TotalServExonerado=None,
                 ...
                 TotalImpuesto=0.00, TotalIVADevuelto=None, TotalOtrosCargos=0.00, TotalComprobante=None,
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CodigoTipoMoneda':
            ...
            obj_ = MedioPago.factory()
            obj_.build(child_)
            self.MedioPago.append(obj_)
            obj_.original_tagname_ = 'MedioPago'
...
class MedioPago(GeneratedsSuper):
    ...
    def __init__(self, TipoMedioPago=None, MedioPagoOtros=None, TotalMedioPago=None):
        self.original_tagname_ = None
        self.TipoMedioPago = TipoMedioPago
        self.MedioPagoOtros = MedioPagoOtros
        self.TotalMedioPago = TotalMedioPago

    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, MedioPago)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if MedioPago.subclass:
            return MedioPago.subclass(*args_, **kwargs_)
        else:
            return MedioPago(*args_, **kwargs_)
    ...
    def get_MedioPagoOtros(self):
        return self.MedioPagoOtros

    def set_MedioPagoOtros(self, MedioPagoOtros):
        self.MedioPagoOtros = MedioPagoOtros
    ...
    def hasContent_(self):
        if (
                ...
                self.MedioPagoOtros is not None or
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ResumenFacturaType', fromsubclass_=False,
        ...
        if self.MedioPagoOtros is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<MedioPagoOtros>%s</MedioPagoOtros>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.MedioPagoOtros), input_name='MedioPagoOtros')),
                eol_)).encode()))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'TipoMedioPago':
            self.TipoMedioPago = child_.text
        elif nodeName_ == 'TotalMedioPago':
            self.TotalMedioPago = child_.text
...
class InformacionReferenciaType(GeneratedsSuper):
    ...
    def __init__(self, TipoDoc=None, TipoDocRefOTRO=None, Numero=None, FechaEmision=None, Codigo=None,
                 CodigoReferenciaOTRO=None, Razon=None):
        self.original_tagname_ = None
        self.TipoDoc = TipoDoc
        self.TipoDocRefOTRO = TipoDocRefOTRO
        self.Numero = Numero
        if isinstance(FechaEmision, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(FechaEmision, '%Y-%m-%dT%H:%M:%S')
        else:
        ...
        self.FechaEmision = initvalue_
        self.Codigo = Codigo
        self.CodigoReferenciaOTRO = CodigoReferenciaOTRO
        self.Razon = Razon
    ...
    def get_TipoDocRefOTRO(self):
        return self.TipoDocRefOTRO

    def set_TipoDocRefOTRO(self, TipoDocRefOTRO):
        self.TipoDocRefOTRO = TipoDocRefOTRO
    ...
    def get_CodigoReferenciaOTRO(self):
        return self.CodigoReferenciaOTRO

    def set_CodigoReferenciaOTRO(self, CodigoReferenciaOTRO):
        self.CodigoReferenciaOTRO = CodigoReferenciaOTRO
    ...
    def hasContent_(self):
        if (
                ...
                self.TipoDocRefOTRO is not None or
                self.Numero is not None or
                self.FechaEmision is not None or
                self.Codigo is not None or
                self.CodigoReferenciaOTRO is not None or
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='InformacionReferenciaType', fromsubclass_=False,
        ...
        if self.TipoDoc is not None:
            ...
            outfile.write(bytes(('<TipoDocIR>%s</TipoDocIR>%s' % (
                ...
                eol_)).encode()))
        if self.TipoDocRefOTRO is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<TipoDocRefOTRO>%s</TipoDocRefOTRO>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.TipoDocRefOTRO), input_name='TipoDocRefOTRO')),
                eol_)).encode()))
        if self.Numero is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<Numero>%s</Numero>%s' % (
        ...
        if self.Codigo is not None:
            ...
            outfile.write(bytes(('<Codigo>%s</Codigo>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.Codigo), input_name='Codigo')), eol_)).encode()))
        if self.CodigoReferenciaOTRO is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<CodigoReferenciaOTRO>%s</CodigoReferenciaOTRO>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.CodigoReferenciaOTRO), input_name='CodigoReferenciaOTRO')), eol_)).encode()))
...
class NormativaType(GeneratedsSuper):
    subclass = None
    superclass = None

    def __init__(self, NumeroResolucion=None, FechaResolucion=None):
        self.original_tagname_ = None
        self.NumeroResolucion = NumeroResolucion
        self.FechaResolucion = FechaResolucion

    def get_NumeroResolucion(self):
        return self.NumeroResolucion

    def set_NumeroResolucion(self, NumeroResolucion):
        self.NumeroResolucion = NumeroResolucion

    def get_FechaResolucion(self):
        return self.FechaResolucion

    def set_FechaResolucion(self, FechaResolucion):
        self.FechaResolucion = FechaResolucion

    def hasContent_(self):
        if (
                self.NumeroResolucion is not None or
                self.FechaResolucion is not None
        ):
            return True
        else:
            return False

    def export(self, outfile, level, namespace_='', name_='NormativaType', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('NormativaType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write(bytes(('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '',)).encode()))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='NormativaType')
        if self.hasContent_():
            outfile.write(bytes(('>%s' % (eol_,)).encode()))
            self.exportChildren(outfile, level + 1, namespace_='', name_='NormativaType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('</%s%s>%s' % (namespace_, name_, eol_)).encode()))
        else:
            outfile.write(bytes(('/>%s' % (eol_,)).encode()))

    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='NormativaType'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='NormativaType', fromsubclass_=False,
                       pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.NumeroResolucion is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<NumeroResolucion>%s</NumeroResolucion>%s' % (
                self.gds_encode(
                    self.gds_format_string(quote_xml(self.NumeroResolucion), input_name='NumeroResolucion')),
                eol_)).encode()))
        if self.FechaResolucion is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<FechaResolucion>%s</FechaResolucion>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.FechaResolucion), input_name='FechaResolucion')),
                eol_)).encode()))
...
def parseString(inString, silence=False):
    ...
    rootClass = NotaCreditoElectronica
    rootObj = rootClass.factory(Clave=None, ProveedorSistemas=None, CodigoActividadEmisor=None, NumeroConsecutivo=None,
                                FechaEmision=None, Emisor=None, CondicionVenta=None)
