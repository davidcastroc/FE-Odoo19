...
class NotaDebitoElectronica(GeneratedsSuper):
    ...
    def __init__(self, Clave, ProveedorSistemas, CodigoActividadEmisor, NumeroConsecutivo, FechaEmision, Emisor,
                 ...
                 DetalleServicio=None, OtrosCargos=None, ResumenFactura=None, InformacionReferencia=None, Otros=None):
...
class ImpuestoType(GeneratedsSuper):
    ...
    def __init__(self, Codigo=None, CodigoTarifaIVA=None, Tarifa=None, FactorIVA=None, Monto=None, MontoExportacion=None,
                 Exoneracion=None, indicator_prod_service=None):
        self.original_tagname_ = None
        self.Codigo = Codigo
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ImpuestoType', fromsubclass_=False,
        ...
        if self.Tarifa is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<Tarifa>%s</Tarifa>%s' % (self.gds_format_float(self.Tarifa, input_name='Tarifa'), eol_)).encode()))
        ...
        if self.Monto is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write(bytes(('<Monto>%s</Monto>%s' % (self.gds_format_float(self.Monto, input_name='Monto'), eol_)).encode()))
...
class LineaDetalleType(GeneratedsSuper):
    ...
    def __init__(self, NumeroLinea=None, PartidaArancelaria=None, CodigoCABYS=None, CodigoComercial=None, Cantidad=None,
                 UnidadMedida=None, UnidadMedidaComercial=None, Detalle=None, RegistroMedicamento=None,
                 FormaFarmaceutica=None, DetalleSurtido=None, PrecioUnitario=None, MontoTotal=None, Descuento=None,
