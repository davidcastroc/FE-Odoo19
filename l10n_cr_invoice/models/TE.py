...
class TiqueteElectronico(GeneratedsSuper):
    ...
    def __init__(self, Clave, ProveedorSistemas, CodigoActividadEmisor, NumeroConsecutivo, FechaEmision, Emisor,
                 CondicionVenta, Receptor=None, PlazoCredito=None, DetalleServicio=None,
    ...
    def export(self, outfile, level, namespace_='', name_='TiqueteElectronico', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('TiqueteElectronico')
        ...
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='TiqueteElectronico')
        if self.hasContent_():
            outfile.write(bytes(('>%s' % (eol_,)).encode()))
            self.exportChildren(outfile, level + 1, namespace_='', name_='TiqueteElectronico',
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TiqueteElectronico'):
        pass

    def exportChildren(self, outfile, level, namespace_='', name_='TiqueteElectronico', fromsubclass_=False,
                       pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
...
class ReceptorType(GeneratedsSuper):
    ...
    def __init__(self, Nombre=None, Identificacion=None, NombreComercial=None,
...
class LineaDetalleType(GeneratedsSuper):
    ...
    def __init__(self, NumeroLinea, CodigoCABYS=None, Cantidad=None, CodigoComercial=None, UnidadMedida=None,
                 UnidadMedidaComercial=None, Detalle=None, RegistroMedicamento=None, FormaFarmaceutica=None,
                 DetalleSurtido=None, PrecioUnitario=None, MontoTotal=None, Descuento=None, SubTotal=None,
                 BaseImponible=None, ImpuestoAsumidoEmisorFabrica=None, Impuesto=None, ImpuestoNeto=None,
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='LineaDetalleType', fromsubclass_=False,
        ...
        if self.CodigoCABYS is not None:
            ...
            outfile.write(bytes(('<CodigoCABYS>%s</CodigoCABYS>%s' % (
                self.gds_encode(self.gds_format_string(quote_xml(self.CodigoCABYS), input_name='Codigo')),
                eol_)).encode()))
